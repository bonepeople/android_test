...
public class Fragment_setinfo_shigongdui_step3 extends DEBUG_Fragment implements OnClickListener
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		_type = new InformationBar(getActivity(), _body, 6, new String[] { "认证类型", "独立工队", "装修公司工队", "1" }, false);
		_name = new InformationBar(getActivity(), _body, 5, new String[] { "工长姓名", "" }, true);
	...
	public void onClick(View v)
	{
		...
		if (_id == R.id.button_commit)
		{
			...
			int _str_type = _type.getData().equals("独立工队") ? 1 : 2;
			...
			else
			{
				...
				_value.put("authenticationType", _str_type);
